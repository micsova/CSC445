 ...
 *
 *
 * @see org.apache.commons.net.tftp.TFTPPacket
 * @see org.apache.commons.net.tftp.TFTPPacketException
 * @see TFTP
 ***/
...
public final class TFTPDataPacket extends TFTPPacket
{
    ...
    {
        super(org.apache.commons.net.tftp.TFTPPacket.DATA, destination, port);
    ...
    public TFTPDataPacket(TFTPDataPacket p) {
        this(p._address, p._port, p._blockNumber, p._data, p._offset, p._length);
    }
     ...
     * @throws org.apache.commons.net.tftp.TFTPPacketException  If the datagram isn't a valid TFTP
     *         data packet.
     ***/
